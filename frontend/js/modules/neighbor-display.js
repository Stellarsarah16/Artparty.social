...
class NeighborDisplay {
    ...
    init() {
        ...
        console.log('✅ Neighbor display initialized');
    }
    ...
    updateDisplay(tile, neighbors = []) {
        if (!this.initialized) {
            console.warn('⚠️ Neighbor display not initialized yet');
            return;
        }
...
const neighborDisplay = new NeighborDisplay();

// Export for use in other modules
export { neighborDisplay };
export default neighborDisplay; 